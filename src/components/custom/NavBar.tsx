...
const NavBar = () => {
  return (
    <div className=" flex items-center justify-between p-4 px-20 bg-transparent backdrop-blur-lg fixed top-0 left-0 right-0 z-50">
      <Link to="/" className="font-bold text-3xl text-accent-foreground cursor-pointer">
        adz
      </Link>
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[600px] lg:grid-cols-3">
                ...
                <ListItem href="/web-metrics-report" title="Web Metrics Report">
